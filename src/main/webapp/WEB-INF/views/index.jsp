          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="report/report">Report</a></li>
                      </ul>
                  </li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="<c:url value='/static/img/Germany.png'/>" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="<c:url value='/static/img/India.png'/>" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="<c:url value='/static/img/Spain.png'/>" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                          <img src="<c:url value='/static/img/user.jpg'/>" alt=""/>
                        </div>
                      ...
                      <li class="by-other">
                        ...
                        <div class="avatar pull-right">
                          <img src="<c:url value='/static/img/user22.png'/>" alt=""/>
                        </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="<c:url value='/static/img/avatar1_small.jpg'/>">
                                        Jenifer smith
                                </span>                                
                              </div>
                            </div>
